...
- orientation priority: 0.0092
- strictへ戻す問い: 外部キックなしでも内部揺らぎへの応答・修復・分岐の同じ統計が現れるか
- strict evidenceに数える: **NO**

## 8. 急冷速度だけで探索統計は再現可能に変わるか
- provenance: `DRIVEN_EXPLORATORY`
