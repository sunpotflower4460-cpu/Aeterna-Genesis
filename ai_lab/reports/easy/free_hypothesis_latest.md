...
- orientation priority: 0.00843
- strictへ戻す問い: 外部周期を置かず、内部時定数の比だけで同様の周期・分岐が自発するか
- strict evidenceに数える: **NO**

## 6. 急冷速度だけで探索統計は再現可能に変わるか
- provenance: `DRIVEN_EXPLORATORY`
