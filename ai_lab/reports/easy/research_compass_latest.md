...
同条件 114/138、近い条件 90/138、対照 0/138。対照で消える傾向があるため、単なる反復回数より成立条件を絞る価値があります。
...
8661回、64個の独立seed、64条件で観測。ただし広く出すぎるため、今後は回数を増やすより『何を変えると消えるか』を優先します。
...
持続2渦 28件（pair-only 24件）、3渦の局所エネルギー 18件。形だけで関係を選んだ後にエネルギーを測っています。
