...
latest strict burst: `dream-20260904-0669`
continuity digest: `29c6a719ec4a76c8cab7`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=37, pair-only=27, triads=26, split-asym=0.150429, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
