...
latest strict burst: `dream-20260914-0919`
continuity digest: `9103c73479535a55ce70`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=5/7, control=7/10, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=26, pair-only=24, triads=18, split-asym=0.141009, no-split-asym=0.252786, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
