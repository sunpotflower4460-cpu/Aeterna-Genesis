...
latest strict burst: `dream-20260921-1076`
continuity digest: `ee772a673f08add2df9e`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=0/2, control=11/19, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=25, triads=21, split-asym=None, no-split-asym=0.032307, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
