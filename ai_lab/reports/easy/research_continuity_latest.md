...
latest strict burst: `dream-20260920-1061`
continuity digest: `6725963f6eaf2c26696c`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/4, control=13/20, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=19, triads=27, split-asym=0.302758, no-split-asym=2.7e-05, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
