...
latest strict burst: `dream-20260923-1137`
continuity digest: `30f95a37e99f83079a80`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=20, triads=21, split-asym=0.084456, no-split-asym=0.128861, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
