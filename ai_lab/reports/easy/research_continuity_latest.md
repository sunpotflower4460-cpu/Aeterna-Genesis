...
latest strict burst: `dream-20260910-0816`
continuity digest: `3f6e3d8df40211c26376`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=27, triads=23, split-asym=0.051908, no-split-asym=0.111203, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
