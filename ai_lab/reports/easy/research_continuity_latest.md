...
latest strict burst: `dream-20260909-0786`
continuity digest: `5c4ac49e8bf392e211de`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=27, triads=21, split-asym=0.436274, no-split-asym=0.116253, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
