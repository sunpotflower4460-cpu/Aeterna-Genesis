...
latest strict burst: `dream-20260828-0509`
continuity digest: `5f686b757dde2fa68c7e`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=28, triads=21, split-asym=0.184391, no-split-asym=0.005272, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
