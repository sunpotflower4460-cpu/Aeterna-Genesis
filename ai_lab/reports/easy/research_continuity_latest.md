...
latest strict burst: `dream-20260831-0575`
continuity digest: `b2a276f3a5dcb5b87cb8`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=26, triads=21, split-asym=0.082541, no-split-asym=0.057664, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=15/31, nearby=?, control=0/31. 回数だけでなく、何を変えると消えるかを追う。
...
- `x:X-deea6a8f25` [strict/open-ended-followup] — X-deea6a8f25: status=REPEATED_SPECIFIC_CANDIDATE; same=8/27, nearby=?, control=0/27. 回数だけでなく、何を変えると消えるかを追う。
