...
latest strict burst: `dream-20260915-0934`
continuity digest: `38c9da1f4c706507a266`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/5, control=4/8, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=24, pair-only=22, triads=13, split-asym=0.116602, no-split-asym=0.16458, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
