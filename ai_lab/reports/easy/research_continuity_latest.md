...
latest strict burst: `dream-20260829-0517`
continuity digest: `05517c29fe1ce3928d8d`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=19, pair-only=18, triads=16, split-asym=0.06637, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
