...
latest strict burst: `dream-20260830-0562`
continuity digest: `bbb198e947f676adf64b`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=35, pair-only=31, triads=22, split-asym=0.061765, no-split-asym=0.007821, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fa3969eebd` [strict/open-ended-followup] — X-fa3969eebd: status=REPEATED_SPECIFIC_CANDIDATE; same=13/33, nearby=?, control=0/33. 回数だけでなく、何を変えると消えるかを追う。
...
- `x:X-ee656d0a1c` [strict/open-ended-followup] — X-ee656d0a1c: status=REPEATED_SPECIFIC_CANDIDATE; same=3/5, nearby=?, control=0/5. 回数だけでなく、何を変えると消えるかを追う。
...
- `x:X-dcc459d23a` [strict/open-ended-followup] — X-dcc459d23a: status=REPEATED_SPECIFIC_CANDIDATE; same=73/91, nearby=?, control=0/91. 回数だけでなく、何を変えると消えるかを追う。
