...
latest strict burst: `dream-20260913-0883`
continuity digest: `6b10b8ca3ebdd4b698d9`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=27, triads=20, split-asym=0.066174, no-split-asym=0.742663, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-deea6a8f25` [strict/open-ended-followup] — X-deea6a8f25: status=REPEATED_SPECIFIC_CANDIDATE; same=17/52, nearby=?, control=0/52. 回数だけでなく、何を変えると消えるかを追う。
