...
latest strict burst: `dream-20260831-0570`
continuity digest: `de4d066f38d3a994523c`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/5, control=13/18, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=22, triads=24, split-asym=0.955047, no-split-asym=0.322019, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
