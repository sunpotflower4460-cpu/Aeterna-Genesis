...
latest strict burst: `dream-20260911-0845`
continuity digest: `3fb09e9a218a8ddb44c4`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=37, pair-only=32, triads=22, split-asym=0.036315, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
