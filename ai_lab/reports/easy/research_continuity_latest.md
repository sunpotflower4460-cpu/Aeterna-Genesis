...
latest strict burst: `dream-20260907-0743`
continuity digest: `bd6b43d1f1ee998dbb1c`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=26, triads=22, split-asym=0.281625, no-split-asym=0.0, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
