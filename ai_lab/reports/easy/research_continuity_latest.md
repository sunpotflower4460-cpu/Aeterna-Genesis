...
latest strict burst: `dream-20260914-0917`
continuity digest: `4019827e9ea8fee17392`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=25, triads=18, split-asym=0.181304, no-split-asym=0.0, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-deea6a8f25` [strict/open-ended-followup] — X-deea6a8f25: status=REPEATED_SPECIFIC_CANDIDATE; same=20/58, nearby=?, control=0/58. 回数だけでなく、何を変えると消えるかを追う。
