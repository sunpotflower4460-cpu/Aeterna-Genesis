...
latest strict burst: `dream-20260925-1172`
continuity digest: `71bd7130e6c5608b7336`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=26, triads=21, split-asym=0.215378, no-split-asym=0.368802, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
