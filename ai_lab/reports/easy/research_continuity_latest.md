...
latest strict burst: `dream-20260917-0991`
continuity digest: `ec4bccd5359f151a7777`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/5, control=11/14, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=26, triads=20, split-asym=0.07023, no-split-asym=0.018047, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
