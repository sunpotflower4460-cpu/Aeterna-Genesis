...
latest strict burst: `dream-20260910-0815`
continuity digest: `7208dcd80ad462afe0ff`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=34, pair-only=28, triads=23, split-asym=0.294157, no-split-asym=0.099167, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
