...
latest strict burst: `dream-20260905-0684`
continuity digest: `928acec1da8170040d9b`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=38, pair-only=36, triads=19, split-asym=0.153524, no-split-asym=0.132147, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
