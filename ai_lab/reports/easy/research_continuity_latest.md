...
latest strict burst: `dream-20260828-0511`
continuity digest: `82119e4b3b4a60a224c6`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=2/4, control=11/16, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=25, triads=21, split-asym=0.069714, no-split-asym=0.027004, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
