...
latest strict burst: `dream-20260912-0861`
continuity digest: `de09d3b143edcb1ea7f0`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=5/7, control=10/16, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=27, triads=25, split-asym=0.100332, no-split-asym=0.234884, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
