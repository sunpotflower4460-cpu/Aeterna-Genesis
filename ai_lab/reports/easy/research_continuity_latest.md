...
latest strict burst: `dream-20260904-0661`
continuity digest: `15a6b396a4e628336abb`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=0/1, control=9/15, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=34, pair-only=29, triads=18, split-asym=None, no-split-asym=0.0, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
