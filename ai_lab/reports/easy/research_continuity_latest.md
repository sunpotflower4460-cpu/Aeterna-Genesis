...
latest strict burst: `dream-20260907-0739`
continuity digest: `d4167ecb066bb9962ffe`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=30, triads=21, split-asym=0.180759, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
