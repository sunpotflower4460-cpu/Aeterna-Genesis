...
latest strict burst: `dream-20260902-0624`
continuity digest: `4f225792547bb7da1a2f`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=28, pair-only=25, triads=20, split-asym=0.209872, no-split-asym=0.161939, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fc51cd23fe` [strict/open-ended-followup] — X-fc51cd23fe: status=REPEATED_SPECIFIC_CANDIDATE; same=2/14, nearby=?, control=0/14. 回数だけでなく、何を変えると消えるかを追う。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=18/39, nearby=?, control=0/39. 回数だけでなく、何を変えると消えるかを追う。
...
- `x:X-dcc459d23a` [strict/open-ended-followup] — X-dcc459d23a: status=REPEATED_SPECIFIC_CANDIDATE; same=77/95, nearby=?, control=0/95. 回数だけでなく、何を変えると消えるかを追う。
