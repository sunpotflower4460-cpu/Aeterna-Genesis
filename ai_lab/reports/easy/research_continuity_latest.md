...
latest strict burst: `dream-20260921-1088`
continuity digest: `07800a3947ef6838c0d9`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/4, control=12/17, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=25, triads=22, split-asym=0.036435, no-split-asym=0.001216, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
