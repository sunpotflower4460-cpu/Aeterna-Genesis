...
latest strict burst: `dream-20260830-0553`
continuity digest: `4abbe01d62a3e554a6de`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=1/2, control=7/9, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=22, pair-only=22, triads=12, split-asym=0.001207, no-split-asym=0.042055, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
