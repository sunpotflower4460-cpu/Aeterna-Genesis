...
latest strict burst: `dream-20260822-0368`
continuity digest: `aa634de7552e3bf5dd1c`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=30, triads=19, split-asym=0.112239, no-split-asym=0.0, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=9/20, nearby=?, control=0/20. 回数だけでなく、何を変えると消えるかを追う。
