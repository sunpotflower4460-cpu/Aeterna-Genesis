...
latest strict burst: `dream-20260912-0872`
continuity digest: `daab46c95aa2f9000e83`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/4, control=8/14, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=19, triads=20, split-asym=0.132401, no-split-asym=0.049999, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
