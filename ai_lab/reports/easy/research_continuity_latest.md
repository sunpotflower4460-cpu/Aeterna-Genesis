...
latest strict burst: `dream-20260823-0402`
continuity digest: `a156fe7fe8126a309412`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/4, control=13/18, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=24, triads=24, split-asym=0.092111, no-split-asym=0.126588, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
