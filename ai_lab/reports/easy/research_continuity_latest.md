...
latest strict burst: `dream-20260831-0572`
continuity digest: `ec58a09b908679f3f8cb`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=22, triads=21, split-asym=0.150394, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
