...
latest strict burst: `dream-20260903-0644`
continuity digest: `7bb2d8e2d9d5fb363d50`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=2/4, control=15/21, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=36, pair-only=27, triads=25, split-asym=0.03778, no-split-asym=0.244349, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
