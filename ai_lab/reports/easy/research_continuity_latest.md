...
latest strict burst: `dream-20260925-1171`
continuity digest: `c58e0d8027b2847096ed`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=5/7, control=4/13, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=18, triads=22, split-asym=0.05486, no-split-asym=0.063323, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
