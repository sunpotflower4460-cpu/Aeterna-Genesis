...
latest strict burst: `dream-20260910-0807`
continuity digest: `4d9fe4e4687d8b102593`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=36, pair-only=29, triads=25, split-asym=0.029987, no-split-asym=0.01681, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
