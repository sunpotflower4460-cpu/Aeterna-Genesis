...
latest strict burst: `dream-20260911-0826`
continuity digest: `fead0777627cf6386386`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/5, control=8/10, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=21, pair-only=17, triads=15, split-asym=0.193193, no-split-asym=0.094631, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
