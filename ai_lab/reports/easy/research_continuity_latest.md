...
latest strict burst: `dream-20260912-0867`
continuity digest: `1afca08cb51d220f2d28`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=25, triads=22, split-asym=0.257228, no-split-asym=0.006435, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-ffb5d5b31a` [strict/open-ended-followup] — X-ffb5d5b31a: status=REPEATED_SPECIFIC_CANDIDATE; same=0/27, nearby=?, control=0/27. 回数だけでなく、何を変えると消えるかを追う。
