...
latest strict burst: `dream-20260919-1025`
continuity digest: `11beb3c8db27c977de99`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/8, control=8/11, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=28, triads=19, split-asym=0.193718, no-split-asym=0.192244, energy-before-geometry=4. 因果・力・結合エネルギーとはまだ呼ばない。
