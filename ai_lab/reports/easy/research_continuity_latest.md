...
latest strict burst: `dream-20260906-0715`
continuity digest: `fb9707c950a144e7e189`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/6, control=16/20, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=36, pair-only=28, triads=27, split-asym=0.705478, no-split-asym=0.090458, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
