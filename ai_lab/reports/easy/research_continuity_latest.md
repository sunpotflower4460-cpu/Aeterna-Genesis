...
latest strict burst: `dream-20260904-0659`
continuity digest: `d91fade9500d89717f8c`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/5, control=5/9, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=22, pair-only=21, triads=14, split-asym=0.088387, no-split-asym=0.037564, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
