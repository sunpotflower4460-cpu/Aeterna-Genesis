...
latest strict burst: `dream-20260903-0640`
continuity digest: `be12fd560177ccfd4d88`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/8, control=20/27, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=48, pair-only=38, triads=36, split-asym=0.221843, no-split-asym=0.070849, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fa3969eebd` [strict/open-ended-followup] — X-fa3969eebd: status=REPEATED_SPECIFIC_CANDIDATE; same=16/40, nearby=?, control=0/40. 回数だけでなく、何を変えると消えるかを追う。
