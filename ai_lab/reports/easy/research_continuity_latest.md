...
latest strict burst: `dream-20260922-1094`
continuity digest: `d756283db6e474bad061`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=6/8, control=17/23, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=47, pair-only=41, triads=31, split-asym=0.067846, no-split-asym=0.157281, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
