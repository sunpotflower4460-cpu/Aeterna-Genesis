...
latest strict burst: `dream-20260827-0498`
continuity digest: `c4749f304e079b08f035`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=6/10, control=14/21, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=57, pair-only=49, triads=34, split-asym=0.049353, no-split-asym=0.039647, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=13/27, nearby=?, control=0/27. 回数だけでなく、何を変えると消えるかを追う。
