...
latest strict burst: `dream-20260903-0658`
continuity digest: `4c362fc666ec0c76ae46`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=34, pair-only=29, triads=24, split-asym=0.243093, no-split-asym=0.149887, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
