...
latest strict burst: `dream-20260911-0837`
continuity digest: `16e5008b5d104920020e`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=26, triads=17, split-asym=0.017977, no-split-asym=0.019583, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=28/55, nearby=?, control=0/55. 回数だけでなく、何を変えると消えるかを追う。
...
- `x:X-deea6a8f25` [strict/open-ended-followup] — X-deea6a8f25: status=REPEATED_SPECIFIC_CANDIDATE; same=17/50, nearby=?, control=0/50. 回数だけでなく、何を変えると消えるかを追う。
