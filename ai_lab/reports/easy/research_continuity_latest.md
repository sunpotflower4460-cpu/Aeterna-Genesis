...
latest strict burst: `dream-20260920-1052`
continuity digest: `9ccc960cf2bf9acc144b`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=28, triads=22, split-asym=0.080766, no-split-asym=0.00036, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
