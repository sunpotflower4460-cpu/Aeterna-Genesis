...
latest strict burst: `dream-20260917-0988`
continuity digest: `6ab7af304483cbd4e817`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=26, pair-only=22, triads=21, split-asym=0.118796, no-split-asym=0.067512, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fa3969eebd` [strict/open-ended-followup] — X-fa3969eebd: status=REPEATED_SPECIFIC_CANDIDATE; same=33/67, nearby=?, control=0/67. 回数だけでなく、何を変えると消えるかを追う。
