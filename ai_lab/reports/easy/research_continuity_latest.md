...
latest strict burst: `dream-20260824-0425`
continuity digest: `d39a3c10b2f02c9fa342`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/4, control=8/12, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=29, triads=17, split-asym=0.070803, no-split-asym=0.174919, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
