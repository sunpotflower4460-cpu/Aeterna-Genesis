...
latest strict burst: `dream-20260911-0840`
continuity digest: `efc1060175b05ee60c95`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=30, triads=19, split-asym=0.041112, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
