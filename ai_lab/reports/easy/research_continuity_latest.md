...
latest strict burst: `dream-20260831-0574`
continuity digest: `d0c3f62197e9ea2fb422`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=23, triads=22, split-asym=0.359854, no-split-asym=0.044908, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
