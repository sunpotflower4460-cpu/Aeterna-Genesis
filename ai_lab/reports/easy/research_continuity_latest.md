...
latest strict burst: `dream-20260909-0782`
continuity digest: `236071b26b92da407996`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/5, control=23/30, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=50, pair-only=40, triads=36, split-asym=0.170625, no-split-asym=0.158107, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
