...
latest strict burst: `dream-20260829-0529`
continuity digest: `9321da87b077cf791005`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=22, pair-only=19, triads=17, split-asym=0.023939, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
