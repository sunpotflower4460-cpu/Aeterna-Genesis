...
latest strict burst: `dream-20260829-0518`
continuity digest: `c0fcb77056036fb6df56`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=25, triads=24, split-asym=0.05282, no-split-asym=0.128163, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
