...
latest strict burst: `dream-20260907-0742`
continuity digest: `4f74ce2e6d5f415077fa`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=22, pair-only=20, triads=15, split-asym=0.007181, no-split-asym=0.022128, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
