...
latest strict burst: `dream-20260830-0546`
continuity digest: `5dbde86f89cb6521fd11`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=21, triads=21, split-asym=0.168517, no-split-asym=0.090907, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fa3969eebd` [strict/open-ended-followup] — X-fa3969eebd: status=REPEATED_SPECIFIC_CANDIDATE; same=13/31, nearby=?, control=0/31. 回数だけでなく、何を変えると消えるかを追う。
