...
latest strict burst: `dream-20260905-0689`
continuity digest: `38d5a451b041a13de4fa`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=22, triads=18, split-asym=0.174034, no-split-asym=0.132147, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-deea6a8f25` [strict/open-ended-followup] — X-deea6a8f25: status=REPEATED_SPECIFIC_CANDIDATE; same=12/36, nearby=?, control=0/36. 回数だけでなく、何を変えると消えるかを追う。
