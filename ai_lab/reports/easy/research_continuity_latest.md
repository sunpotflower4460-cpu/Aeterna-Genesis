...
latest strict burst: `dream-20260825-0445`
continuity digest: `0518aff6e04355a56048`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=6/7, control=7/9, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=23, pair-only=20, triads=17, split-asym=0.128719, no-split-asym=0.104591, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
