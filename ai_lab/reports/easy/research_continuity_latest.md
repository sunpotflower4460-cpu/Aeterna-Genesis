...
latest strict burst: `dream-20260901-0603`
continuity digest: `c0910483c69b59467066`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=1/2, control=16/20, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=26, triads=23, split-asym=0.0, no-split-asym=0.046169, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
