...
latest strict burst: `dream-20260921-1078`
continuity digest: `f738275200963dffea9a`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=19, pair-only=17, triads=14, split-asym=0.078581, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
