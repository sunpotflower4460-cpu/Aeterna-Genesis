...
latest strict burst: `dream-20260921-1070`
continuity digest: `f91a9cd2e4ef0ca1a2ac`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=6/8, control=13/20, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=54, pair-only=49, triads=30, split-asym=0.118622, no-split-asym=0.124127, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
