...
latest strict burst: `dream-20260905-0700`
continuity digest: `0f5adcf0175395960d8e`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/6, control=11/15, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=27, triads=24, split-asym=0.063702, no-split-asym=0.562727, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
