...
latest strict burst: `dream-20260916-0957`
continuity digest: `5351fc95a2e06506581d`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=28, triads=20, split-asym=0.068198, no-split-asym=0.16458, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
