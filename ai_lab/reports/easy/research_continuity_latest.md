...
latest strict burst: `dream-20260830-0555`
continuity digest: `4dae3bf6a9d94391af86`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=22, triads=21, split-asym=0.057822, no-split-asym=0.048313, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
