...
latest strict burst: `dream-20260908-0776`
continuity digest: `a64a00d67769ee4ddf30`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=22, triads=21, split-asym=0.032943, no-split-asym=0.212271, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
