...
latest strict burst: `dream-20260907-0735`
continuity digest: `498df8bb566462a2eacf`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=24, triads=14, split-asym=0.244449, no-split-asym=0.250433, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
