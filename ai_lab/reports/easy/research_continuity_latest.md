...
latest strict burst: `dream-20260830-0563`
continuity digest: `86d8a0a4ca6b23e71aa4`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=25, triads=16, split-asym=0.087644, no-split-asym=0.056671, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
