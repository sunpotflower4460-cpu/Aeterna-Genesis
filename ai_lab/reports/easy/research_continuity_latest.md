...
latest strict burst: `dream-20260914-0902`
continuity digest: `60121b55e65ce0b90dc2`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=25, triads=20, split-asym=0.065487, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
