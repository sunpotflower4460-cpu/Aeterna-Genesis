...
latest strict burst: `dream-20260904-0673`
continuity digest: `1ffd9d801a8ef8b90914`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=38, pair-only=30, triads=23, split-asym=0.30277, no-split-asym=0.043507, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
