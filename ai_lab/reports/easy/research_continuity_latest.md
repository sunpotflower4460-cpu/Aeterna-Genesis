...
latest strict burst: `dream-20260830-0554`
continuity digest: `42f7690191b6777596d6`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=24, pair-only=15, triads=18, split-asym=0.048813, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
