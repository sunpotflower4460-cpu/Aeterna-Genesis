...
latest strict burst: `dream-20260914-0905`
continuity digest: `f93c4c7e9bdc2253c5c5`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=34, pair-only=30, triads=24, split-asym=0.055845, no-split-asym=0.080711, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
