...
latest strict burst: `dream-20260913-0889`
continuity digest: `9b446f0a7c4f56c62b42`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=7/10, control=16/30, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=60, pair-only=52, triads=38, split-asym=0.054693, no-split-asym=0.035419, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fa3969eebd` [strict/open-ended-followup] — X-fa3969eebd: status=REPEATED_SPECIFIC_CANDIDATE; same=27/57, nearby=?, control=0/57. 回数だけでなく、何を変えると消えるかを追う。
