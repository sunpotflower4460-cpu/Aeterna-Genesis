...
latest strict burst: `dream-20260910-0808`
continuity digest: `e56df8d965c6477c77c2`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/9, control=9/13, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=28, triads=23, split-asym=0.001045, no-split-asym=0.071351, energy-before-geometry=3. 因果・力・結合エネルギーとはまだ呼ばない。
