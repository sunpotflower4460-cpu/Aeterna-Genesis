...
latest strict burst: `dream-20260922-1109`
continuity digest: `283192be88b5e1d6929a`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=24, triads=21, split-asym=0.187031, no-split-asym=0.041812, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
