...
latest strict burst: `dream-20260920-1064`
continuity digest: `9c66a059461308cf0dc9`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=27, triads=20, split-asym=0.04831, no-split-asym=0.111668, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
