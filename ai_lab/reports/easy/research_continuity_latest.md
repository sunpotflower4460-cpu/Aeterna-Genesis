...
latest strict burst: `dream-20260923-1120`
continuity digest: `ce785679c1a1a9cacd86`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=23, triads=21, split-asym=0.114255, no-split-asym=0.064306, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
