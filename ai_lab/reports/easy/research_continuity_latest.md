...
latest strict burst: `dream-20260913-0878`
continuity digest: `4b329d18895b76d57ce5`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=8/9, control=20/27, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=48, pair-only=43, triads=36, split-asym=0.278181, no-split-asym=0.081432, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
