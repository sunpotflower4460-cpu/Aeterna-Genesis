...
latest strict burst: `dream-20260921-1089`
continuity digest: `1760fa15aa6eaf540165`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=1/2, control=12/14, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=25, triads=18, split-asym=0.021815, no-split-asym=0.062948, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
