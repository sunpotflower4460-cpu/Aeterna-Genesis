...
latest strict burst: `dream-20260913-0876`
continuity digest: `b8300cdbbbf6bbfb73fa`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=25, triads=18, split-asym=0.0, no-split-asym=0.040598, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
