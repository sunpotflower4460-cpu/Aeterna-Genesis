...
latest strict burst: `dream-20260907-0736`
continuity digest: `59b02594e27329082940`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=28, triads=20, split-asym=0.017696, no-split-asym=0.148034, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=24/47, nearby=?, control=0/47. 回数だけでなく、何を変えると消えるかを追う。
