...
latest strict burst: `dream-20260918-1011`
continuity digest: `63658569fec1d3e40a0b`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=4/5, control=10/15, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=29, triads=21, split-asym=0.161481, no-split-asym=0.030915, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
