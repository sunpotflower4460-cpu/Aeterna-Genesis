...
latest strict burst: `dream-20260821-0345`
continuity digest: `d1197dfb42c16b39232d`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=26, pair-only=23, triads=18, split-asym=0.073449, no-split-asym=0.058537, energy-before-geometry=2. 因果・力・結合エネルギーとはまだ呼ばない。
