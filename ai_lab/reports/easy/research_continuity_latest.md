...
latest strict burst: `dream-20260903-0642`
continuity digest: `13386f2724fa95ff6a5a`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=25, triads=23, split-asym=0.06932, no-split-asym=0.171971, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
