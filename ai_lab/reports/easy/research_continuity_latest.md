...
latest strict burst: `dream-20260916-0959`
continuity digest: `69e4f4b788d9e1bdc880`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=23, triads=22, split-asym=0.282405, no-split-asym=0.001332, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=35/65, nearby=?, control=0/65. 回数だけでなく、何を変えると消えるかを追う。
