...
latest strict burst: `dream-20260903-0649`
continuity digest: `b46f302e8966c7b0f5f4`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=26, pair-only=23, triads=15, split-asym=0.259657, no-split-asym=0.165407, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
