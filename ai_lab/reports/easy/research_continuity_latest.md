...
latest strict burst: `dream-20260915-0924`
continuity digest: `3950bc04ae681dc15293`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=25, triads=19, split-asym=0.034069, no-split-asym=0.008433, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=33/61, nearby=?, control=0/61. 回数だけでなく、何を変えると消えるかを追う。
