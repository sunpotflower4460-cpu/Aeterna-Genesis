...
latest strict burst: `dream-20260908-0763`
continuity digest: `11ba8f68aefc9aac6b01`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=28, triads=21, split-asym=0.181905, no-split-asym=0.011346, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
