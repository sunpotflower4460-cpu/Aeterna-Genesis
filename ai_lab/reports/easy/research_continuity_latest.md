...
latest strict burst: `dream-20260829-0527`
continuity digest: `38aced56c524c73dfdfe`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=26, pair-only=25, triads=21, split-asym=0.025154, no-split-asym=0.034469, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fa3969eebd` [strict/open-ended-followup] — X-fa3969eebd: status=REPEATED_SPECIFIC_CANDIDATE; same=11/29, nearby=?, control=0/29. 回数だけでなく、何を変えると消えるかを追う。
