...
latest strict burst: `dream-20260908-0760`
continuity digest: `31cc9f6b7a40d9b18d65`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=27, pair-only=25, triads=19, split-asym=0.162226, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
