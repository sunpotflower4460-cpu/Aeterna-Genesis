...
latest strict burst: `dream-20260924-1141`
continuity digest: `139368fe944c265c56b6`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=35, pair-only=32, triads=21, split-asym=0.157625, no-split-asym=0.132709, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
