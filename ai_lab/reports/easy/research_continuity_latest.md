...
latest strict burst: `dream-20260831-0571`
continuity digest: `e0a4474fbb4626725b20`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=22, triads=24, split-asym=0.199201, no-split-asym=0.041896, energy-before-geometry=2. 因果・力・結合エネルギーとはまだ呼ばない。
