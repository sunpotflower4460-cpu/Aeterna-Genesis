...
latest strict burst: `dream-20260923-1136`
continuity digest: `475511c38b646c97ff72`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=26, triads=22, split-asym=0.064972, no-split-asym=0.045594, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
