...
latest strict burst: `dream-20260911-0827`
continuity digest: `7a107b6e9f5c9fcf5c1b`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=34, pair-only=29, triads=21, split-asym=0.028589, no-split-asym=0.055693, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
