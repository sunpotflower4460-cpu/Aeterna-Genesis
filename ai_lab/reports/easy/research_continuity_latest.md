...
latest strict burst: `dream-20260909-0799`
continuity digest: `689147ed0f15aaf51dd9`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=26, triads=25, split-asym=0.099612, no-split-asym=0.127272, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
