...
latest strict burst: `dream-20260903-0648`
continuity digest: `533bca9ee5045108e3ae`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=1/2, control=10/21, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=21, triads=24, split-asym=6.2e-05, no-split-asym=0.385591, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
