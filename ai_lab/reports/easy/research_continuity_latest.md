...
latest strict burst: `dream-20260911-0835`
continuity digest: `f5d4ebf23afe2020d20b`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=29, triads=18, split-asym=0.055936, no-split-asym=0.035895, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-deea6a8f25` [strict/open-ended-followup] — X-deea6a8f25: status=REPEATED_SPECIFIC_CANDIDATE; same=16/49, nearby=?, control=0/49. 回数だけでなく、何を変えると消えるかを追う。
