...
latest strict burst: `dream-20260825-0447`
continuity digest: `b1c2c4bf92853faf2a28`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=5/6, control=8/16, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=33, pair-only=27, triads=22, split-asym=0.236791, no-split-asym=0.009405, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
