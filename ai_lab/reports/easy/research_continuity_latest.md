...
latest strict burst: `dream-20260922-1106`
continuity digest: `c19d6b0f9fe86ef7efe4`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=46, pair-only=39, triads=30, split-asym=0.18727, no-split-asym=0.165996, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
