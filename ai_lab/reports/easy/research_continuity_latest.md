...
latest strict burst: `dream-20260922-1091`
continuity digest: `294e712411bab323eee7`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=3/5, control=16/21, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=36, pair-only=30, triads=27, split-asym=0.037717, no-split-asym=0.034914, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
