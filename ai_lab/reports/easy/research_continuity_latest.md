...
latest strict burst: `dream-20260912-0864`
continuity digest: `13eed71c2b51dd9a0dc6`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=25, triads=24, split-asym=0.054284, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
