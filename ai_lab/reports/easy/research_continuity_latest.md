...
latest strict burst: `dream-20260919-1036`
continuity digest: `2c7808d46fd94acdfd3c`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=35, pair-only=32, triads=20, split-asym=0.039651, no-split-asym=0.532183, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
