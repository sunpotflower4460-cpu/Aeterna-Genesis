...
latest strict burst: `dream-20260920-1043`
continuity digest: `271c590a69785c62d233`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=5/8, control=10/11, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=31, triads=21, split-asym=0.100589, no-split-asym=0.093658, energy-before-geometry=3. 因果・力・結合エネルギーとはまだ呼ばない。
