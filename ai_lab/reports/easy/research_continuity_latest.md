...
latest strict burst: `dream-20260922-1092`
continuity digest: `d294bc191b69d4b00735`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=2/3, control=14/21, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=36, pair-only=32, triads=25, split-asym=0.140664, no-split-asym=0.096733, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
