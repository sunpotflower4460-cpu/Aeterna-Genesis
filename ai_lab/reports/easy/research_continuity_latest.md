...
latest strict burst: `dream-20260830-0564`
continuity digest: `5ac410d247a7f8255d06`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=28, pair-only=25, triads=23, split-asym=0.242939, no-split-asym=0.064111, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
