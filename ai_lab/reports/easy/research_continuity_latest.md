...
latest strict burst: `dream-20260907-0731`
continuity digest: `e436127e481515e999a7`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=21, triads=20, split-asym=0.300643, no-split-asym=0.455211, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-fa3969eebd` [strict/open-ended-followup] — X-fa3969eebd: status=REPEATED_SPECIFIC_CANDIDATE; same=20/47, nearby=?, control=0/47. 回数だけでなく、何を変えると消えるかを追う。
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=23/46, nearby=?, control=0/46. 回数だけでなく、何を変えると消えるかを追う。
