...
latest strict burst: `dream-20260829-0524`
continuity digest: `3c2f2d9d50ceb45d9619`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=24, triads=19, split-asym=0.046413, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
