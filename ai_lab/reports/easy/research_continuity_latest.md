...
latest strict burst: `dream-20260912-0870`
continuity digest: `95cf607ebe9e69d3f9a4`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=26, pair-only=22, triads=19, split-asym=0.239609, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
