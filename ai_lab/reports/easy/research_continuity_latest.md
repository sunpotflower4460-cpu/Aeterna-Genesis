...
latest strict burst: `dream-20260919-1035`
continuity digest: `a7fdff03f4ea1dff6810`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=8/11, control=13/18, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=37, pair-only=31, triads=29, split-asym=0.134814, no-split-asym=0.056499, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
