...
latest strict burst: `dream-20260910-0817`
continuity digest: `22c338be84e668871620`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=28, triads=18, split-asym=0.081762, no-split-asym=0.008915, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
