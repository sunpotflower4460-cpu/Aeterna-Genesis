...
latest strict burst: `dream-20260908-0757`
continuity digest: `82e455225e6a681b4a39`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=24, triads=20, split-asym=0.073891, no-split-asym=0.045771, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
