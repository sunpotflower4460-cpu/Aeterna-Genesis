...
latest strict burst: `dream-20260830-0542`
continuity digest: `e209324f0a29a476e474`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=23, triads=20, split-asym=0.434705, no-split-asym=0.090907, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-dcc459d23a` [strict/open-ended-followup] — X-dcc459d23a: status=REPEATED_SPECIFIC_CANDIDATE; same=69/86, nearby=?, control=0/86. 回数だけでなく、何を変えると消えるかを追う。
