...
latest strict burst: `dream-20260915-0925`
continuity digest: `e56c0641a5c925c5fc05`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=28, triads=21, split-asym=0.052939, no-split-asym=0.057817, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=33/62, nearby=?, control=0/62. 回数だけでなく、何を変えると消えるかを追う。
