...
latest strict burst: `dream-20260916-0956`
continuity digest: `af2b398035fb047e18d9`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=2/3, control=11/15, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=28, triads=17, split-asym=0.245977, no-split-asym=0.0, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
