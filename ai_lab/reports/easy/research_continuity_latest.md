...
latest strict burst: `dream-20260921-1075`
continuity digest: `d397e1de9ebd640c02dc`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=25, triads=19, split-asym=0.176445, no-split-asym=0.131336, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
