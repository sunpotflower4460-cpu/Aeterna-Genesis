...
latest strict burst: `dream-20260921-1086`
continuity digest: `0c4be4c1d5566a70b80c`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=1/2, control=12/18, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=27, triads=21, split-asym=0.339577, no-split-asym=0.041598, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
