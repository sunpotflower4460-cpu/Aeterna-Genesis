...
latest strict burst: `dream-20260918-1016`
continuity digest: `a4b0a281a956060ccdbf`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=5/6, control=8/10, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=31, triads=19, split-asym=0.110868, no-split-asym=0.082511, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
