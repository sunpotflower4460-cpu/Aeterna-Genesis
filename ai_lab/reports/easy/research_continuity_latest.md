...
latest strict burst: `dream-20260923-1125`
continuity digest: `eb6205b540e9d73b5a9f`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=25, triads=21, split-asym=0.174867, no-split-asym=0.039257, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-f023a067af` [strict/open-ended-followup] — X-f023a067af: status=REPEATED_SPECIFIC_CANDIDATE; same=45/78, nearby=?, control=0/78. 回数だけでなく、何を変えると消えるかを追う。
