...
latest strict burst: `dream-20260919-1020`
continuity digest: `81c8aecb6d414e5a025b`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=29, pair-only=26, triads=19, split-asym=0.095964, no-split-asym=0.127168, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-deea6a8f25` [strict/open-ended-followup] — X-deea6a8f25: status=REPEATED_SPECIFIC_CANDIDATE; same=22/63, nearby=?, control=0/63. 回数だけでなく、何を変えると消えるかを追う。
