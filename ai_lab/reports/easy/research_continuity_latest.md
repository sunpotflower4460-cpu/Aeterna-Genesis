...
latest strict burst: `dream-20260917-0984`
continuity digest: `34bccf3f4eef92c9bb2f`

過去の重要点を次の研究へ渡す handoff です。元の証拠を置き換えません。

## Must carry forward

- `geometry:triangle-vs-control-separation` [strict-geometry] — 三角形を特別扱いせず対照と比較し続ける。 triangle=2/3, control=15/16, triangle_required=False.
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=32, pair-only=30, triads=20, split-asym=0.327029, no-split-asym=0.045371, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
