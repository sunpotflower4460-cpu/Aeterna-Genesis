...
latest strict burst: `dream-20260908-0764`
continuity digest: `0ad8a87dd2e1db2d59ab`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=30, pair-only=23, triads=19, split-asym=0.118387, no-split-asym=0.000488, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
...
- `x:X-ffb5d5b31a` [strict/open-ended-followup] — X-ffb5d5b31a: status=REPEATED_SPECIFIC_CANDIDATE; same=0/21, nearby=?, control=0/21. 回数だけでなく、何を変えると消えるかを追う。
