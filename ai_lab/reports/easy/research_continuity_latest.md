...
latest strict burst: `dream-20260913-0875`
continuity digest: `32ecc9e659c26ad06dad`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=31, pair-only=23, triads=18, split-asym=0.215197, no-split-asym=0.152729, energy-before-geometry=1. 因果・力・結合エネルギーとはまだ呼ばない。
