...
latest strict burst: `dream-20260905-0683`
continuity digest: `563d37131b690f8a7a1f`
...
- `energy:vertex-asymmetry-vs-geometry` [strict-local-energy] — 局所エネルギーは幾何で関係を選んだ後に測る。 pairs=25, pair-only=20, triads=17, split-asym=0.145971, no-split-asym=None, energy-before-geometry=0. 因果・力・結合エネルギーとはまだ呼ばない。
