...
## Diagnostics modules (21)
`angular_modes`, `bridge_contract`, `corroborate`, `coupled_spectrum`, `dipole_episodes`, `gauge_aligned_distance`, `higher_levels`, `level3_motion`, `measures`, `plaquette_ledger`, `reaction_localization`, `survival_analysis`, `thermodynamic_ledger`, `topology3d`, `topology_betti`, `vessel_flux_3d`, `vessel_geometry_3d`, `vessel_permeability`, `vortex_lines_3d`, `vortex_tracking_v2`, `winding_reliability`
