...
def test_next_effective_rung_skips_horizons_shorter_than_base_observation():
    # Ordinary quick geometry sees ~26 physical-time units.  With tau=4, 4tau=16 is not an extension,
...
def test_deep_time_ladder_is_monotone_and_bounded():
    assert deep_time.next_effective_rung(tau_ref=8.0, base_physical_time=26.0, last_rung=0.0) == 4.0
