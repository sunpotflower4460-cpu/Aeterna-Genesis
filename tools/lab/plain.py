...
METRIC_WORDS = {
    ...
    "flux_per_vortex": "渦 1 本あたりの磁束（2π を 1 とする）", "string_length": "磁束の糸の長さの合計",
    "wrapped_axes": "箱をぐるりと一周している糸の向きの数（0〜3）",
    "triad_skewness": "三角形のそろい方（＋0.8 前後＝山の粒の六角形、－0.8 前後＝谷の粒の六角形、0 近く＝縞）",
    "triangles": "閉じた三角形（3 つの波の組）の数", "triangle_phase": "三角形の位相の和（0 か π。－1＝三角形なし）",
    "rings": "渦の輪（トーラス）の数", "line_pieces": "渦の線のかたまりの数", "line_voxels": "渦の線の太さ込みの量",
    "firing": "発火している場所の割合",
    "kind1_share": "V1 の種類の点の割合（0〜1）", "purity": "点の中の種類のそろい方（1＝どれも 1 種類だけ、0＝半々）",
    "containers": "閉じた入れ物の数", "occupied": "中身（自己複製）が入っている入れ物の数", "box_share": "入れ物が占める割合",
}
